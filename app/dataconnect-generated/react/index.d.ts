import { UpsertUserData, UpsertUserVariables, UpdateUserRoleData, UpdateUserRoleVariables, UpdateUserLocationData, UpdateUserLocationVariables, TriggerEventData, TriggerEventVariables, MarketMakerTradeData, MarketMakerTradeVariables, BuyStockData, BuyStockVariables, SellStockData, SellStockVariables, GenerateTradeHeadlineData, GenerateTradeHeadlineVariables, ExecuteReadXPostTransactionData, ExecuteReadXPostTransactionVariables, TriggerSocialBoostData, TriggerSocialBoostVariables, PanicSellPortfolioData, TriggerMarketCrashData, TriggerMarketCrashVariables, GetDashboardDataData, GetUserProfileData, GetPriceHistoryData, GetPriceHistoryVariables, GetEmojiWhaleStatsData, GetEmojiHistoryStatsData, GetEmojiHistoryStatsVariables, GetChronologicalTickerData, GetEmojiSparklinesData, GetTopTradersData, SearchEmojisData, SearchEmojisVariables, GetTopEmojisByCityData, GetTrendingEmojisNearMeData, GetTrendingEmojisNearMeVariables, VectorSearchEmojisData, VectorSearchEmojisVariables } from '../';
...
export function useGenerateTradeHeadline(options?: useDataConnectMutationOptions<GenerateTradeHeadlineData, FirebaseError, GenerateTradeHeadlineVariables>): UseDataConnectMutationResult<GenerateTradeHeadlineData, GenerateTradeHeadlineVariables>;
export function useGenerateTradeHeadline(dc: DataConnect, options?: useDataConnectMutationOptions<GenerateTradeHeadlineData, FirebaseError, GenerateTradeHeadlineVariables>): UseDataConnectMutationResult<GenerateTradeHeadlineData, GenerateTradeHeadlineVariables>;

export function useExecuteReadXPostTransaction(options?: useDataConnectMutationOptions<ExecuteReadXPostTransactionData, FirebaseError, ExecuteReadXPostTransactionVariables>): UseDataConnectMutationResult<ExecuteReadXPostTransactionData, ExecuteReadXPostTransactionVariables>;
export function useExecuteReadXPostTransaction(dc: DataConnect, options?: useDataConnectMutationOptions<ExecuteReadXPostTransactionData, FirebaseError, ExecuteReadXPostTransactionVariables>): UseDataConnectMutationResult<ExecuteReadXPostTransactionData, ExecuteReadXPostTransactionVariables>;

export function useTriggerSocialBoost(options?: useDataConnectMutationOptions<TriggerSocialBoostData, FirebaseError, TriggerSocialBoostVariables>): UseDataConnectMutationResult<TriggerSocialBoostData, TriggerSocialBoostVariables>;
export function useTriggerSocialBoost(dc: DataConnect, options?: useDataConnectMutationOptions<TriggerSocialBoostData, FirebaseError, TriggerSocialBoostVariables>): UseDataConnectMutationResult<TriggerSocialBoostData, TriggerSocialBoostVariables>;

export function usePanicSellPortfolio(options?: useDataConnectMutationOptions<PanicSellPortfolioData, FirebaseError, void>): UseDataConnectMutationResult<PanicSellPortfolioData, undefined>;
export function usePanicSellPortfolio(dc: DataConnect, options?: useDataConnectMutationOptions<PanicSellPortfolioData, FirebaseError, void>): UseDataConnectMutationResult<PanicSellPortfolioData, undefined>;

export function useTriggerMarketCrash(options?: useDataConnectMutationOptions<TriggerMarketCrashData, FirebaseError, TriggerMarketCrashVariables>): UseDataConnectMutationResult<TriggerMarketCrashData, TriggerMarketCrashVariables>;
export function useTriggerMarketCrash(dc: DataConnect, options?: useDataConnectMutationOptions<TriggerMarketCrashData, FirebaseError, TriggerMarketCrashVariables>): UseDataConnectMutationResult<TriggerMarketCrashData, TriggerMarketCrashVariables>;
...
export function useVectorSearchEmojis(vars: VectorSearchEmojisVariables, options?: useDataConnectQueryOptions<VectorSearchEmojisData>): UseDataConnectQueryResult<VectorSearchEmojisData, VectorSearchEmojisVariables>;
export function useVectorSearchEmojis(dc: DataConnect, vars: VectorSearchEmojisVariables, options?: useDataConnectQueryOptions<VectorSearchEmojisData>): UseDataConnectQueryResult<VectorSearchEmojisData, VectorSearchEmojisVariables>;
